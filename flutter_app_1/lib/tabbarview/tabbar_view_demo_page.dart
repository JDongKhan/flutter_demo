...
import 'tabbar_view_first_page.dart';
import 'tabbar_view_second_page.dart';

/// @author jd

class TabbarViewDemoPage extends StatefulWidget {
  @override
  _TabbarViewDemoPageState createState() => _TabbarViewDemoPageState();
}

class _TabbarViewDemoPageState extends State<TabbarViewDemoPage>
  ...
  void initState() {
    ...
    _tabs.add({
      'title': '首页',
      'icon': Icons.home,
      'page': TabbarViewFirstPage(),
    });

    _tabs.add({
      'title': '朋友',
      'icon': Icons.child_friendly,
      'page': TabbarViewSecondPage(),
    });
